...
RUN	curl -H "Cache-Control: no-cache" https://raw.githubusercontent.com/Wizkiller96/Wizdecker/master/wizbot_installer_2_8_2.sh -o ./wizbot_installer.sh && chmod 755 wizbot_installer.sh && ./wizbot_installer.sh
